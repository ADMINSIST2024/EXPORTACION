 ...
 <div class="login-box" ">
    ...
    <img src="img/seguridad.gif" class="avatar"/>
     <br /><br />
        <%--<h1>Login Here</h1>--%>
     <div >
<img src="img/logo_tecnologiatextil.png"  class="img-responsive"  style=" border-radius: 2em; width:140px;height:120px;margin:auto; "/>
     </div>
          ...
          <%--  <input type="submit" name="submit" value="Login"/>--%>
            ...
            <br />
              <%--  <a href="" style="color:#1ab394;font-weight:bold"></a>    --%>
            </form>
